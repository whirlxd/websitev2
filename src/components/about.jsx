		...
		<div className="bg-base-200">
					...
					>
						<div className="relative flex items-center justify-center w-full h-40 ">
							...
							<div className="relative z-10 text-5xl font-bold tracking-wider md:text-6xl">
								<span className="text-white special">My</span>
								<span className="text-primary special">Tools</span>
							</div>
						</div>
					</AnimationOnScroll>
						...
						<div className="relative">
							<div className="relative p-2 overflow-hidden transition-transform ease-in-out border-b-4 select-none hover:p-1 hover:border-b-8 hover:scale-105 bg-secondary rounded-3xl hover:font-extrabold hover:shadow-teal-200 hover:border-4 border-primary will-change-transform">
								...
								<div className="space-y-2">
									<h3 className="font-bold" aria-hidden="true" />
			...
			<AnimationOnScroll animateIn="fadeInDown" animateOnce="true">
				<div className="relative flex items-center justify-center w-full h-40 ">
					...
					<div className="relative z-10 text-4xl font-bold tracking-wider md:text-6xl">
						<span className="text-white special">My</span>
						<span className="text-primary special">JOURNEY</span>
					</div>
				</div>
			</AnimationOnScroll>
			<br />
			...
			<AnimationOnScroll animateIn="fadeInDown" animateOnce="true">
				<div className="relative flex items-center justify-center w-full h-40 ">
					...
					<div className="relative z-10 text-4xl font-bold tracking-wider md:text-6xl">
						<span className="text-white special">My</span>
						<span className="text-primary special">WORK</span>
					</div>
				</div>
			</AnimationOnScroll>
			<br />
