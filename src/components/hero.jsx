        ...
        <div className="hero-content text-center">
          <div className="max-w-md">
            ...
            <AnimationOnScroll animateIn="lightSpeedInRight">
              <p className="py-6">
                Heyy there 👋, I'm Whirl, a person who can do shit like real
                shit fr. lorem ipsum blah blash blfjwb ndj njn ekn
              </p>
            </AnimationOnScroll>
            ...
            <AnimationOnScroll animateIn="backInUp">
              ...
              <button className="btn btn-circle ml-4 btn-outline btn-secondary">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
                  y="0px"
